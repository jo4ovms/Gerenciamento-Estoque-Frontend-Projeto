...
import { Box, Typography, Button, Stack, Checkbox, FormGroup, FormControlLabel } from '@mui/material';
...
const AuthLogin = () => {
  ...
  return (
    <Box>
      ...
      <Typography variant="subtitle1" textAlign="center" color="textSecondary" mt={2}>
